...
function redisAdapter(redis, opts) {
  ...
  Adapter.call(this);
  if (this.addRemoveClientsOnExit && !this.listenersAdded) {
    this.addRemoveClientsListeners();
 ...
 * the redis
 */
redisAdapter.prototype.addRemoveClientsListeners = function() {
  var adapter = this;
